...
#!nix-shell -i bash -p curl dotnet-sdk_5
set -eo pipefail
...
src="$(mktemp -d /tmp/Beataroni-src.XXX)"
...
dotnet restore Beataroni/Beataroni/Beataroni.csproj --runtime linux-x64 --configfile ./nuget_tmp.config
