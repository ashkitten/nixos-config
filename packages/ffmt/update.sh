...
dotnet restore xivModdingFramework/xivModdingFramework/xivModdingFramework.csproj --runtime linux-x64 --configfile ./nuget_tmp.config
dotnet restore FFXIV_Modding_Tool/FFXIV_Modding_Tool.csproj --runtime linux-x64 --configfile ./nuget_tmp.config
